  ...
  return (
    <div className="flex w-full flex-col items-start bg-blue-700 px-10 lg:px-0">
      ...
      >
        ...
        <div className="hidden items-center space-x-9 font-semibold text-white lg:flex">
        ...
        <div className="flex items-center space-x-3 lg:space-x-0">
          ...
          py-2 px-3 
                text-sm text-black shadow shadow-slate-600 transition-all duration-200 hover:text-blue-600 
                hover:shadow-3xl"
          >
            Login
          </button>
      ...
      {/* description */}
      <div className="z-[9998] flex flex-col items-start space-y-10 py-16 md:py-32 lg:mx-auto lg:max-w-7xl lg:items-center">
        <div className="flex max-w-md flex-col items-start space-y-6 md:space-y-10 lg:max-w-3xl lg:items-center lg:space-y-0">
          <h2 className="text-2xl font-extrabold text-white md:text-6xl">
            IMAGINE A PLACE...
          </h2>
          <p className="text-left text-white lg:text-center">
        ...
        <div className="flex flex-col items-start space-y-10 lg:flex-row lg:items-center lg:space-y-0 lg:space-x-4">
          <button
            className="flex items-center
                 space-x-3 rounded-3xl 
                bg-white py-3 px-6
                    text-xl text-black shadow  shadow-slate-600 transition-all duration-200 hover:text-blue-600 hover:shadow-3xl"
          >
            <span>
              <svg
      ...
      <div className="relative flex h-full w-full">
        <div className="left-0 bottom-0 z-50 ml-[-170px] md:absolute md:hidden lg:inline-block">
          <LeftBg />
        </div>
        <div className="right-0 bottom-0 left-[10%] z-50 ml-[200px] hidden md:absolute md:inline-block lg:left-[50%] lg:ml-[350px]">
          <RightBg />
        </div>
        <div className="absolute right-0 bottom-0 hidden md:inline-block">
          <CenterBg />
        </div>
      </div>
    </div>
