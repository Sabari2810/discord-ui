...
const Footer = () => {
  return (
    <div className="bg-black bg-opacity-[0.85]">
      <div className="mx-auto max-w-6xl space-y-10 px-9 py-20">
        <div className="flex flex-col items-start justify-between space-y-10 md:flex-row md:space-y-0">
          <div className="flex max-w-xs flex-col items-start space-y-4">
            <h2 className="text-4xl font-extrabold text-blue-600">
              IMAGINE A PLACE
            </h2>
            <div className="flex items-center space-x-3 text-white">
              <FaTwitter className="h-6 w-8 cursor-pointer " />
              <FaInstagram className="h-6 w-8 cursor-pointer " />
              <FaFacebook className="h-6 w-8 cursor-pointer  " />
              <FaYoutube className="h-6 w-8 cursor-pointer" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-16 pr-20 lg:grid-cols-4 lg:gap-0">
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <button
            className="rounded-3xl bg-blue-600
                 py-2 px-3 
                text-sm text-white transition-all duration-200 hover:bg-blue-500 
                "
          >
            Sign up
          </button>
